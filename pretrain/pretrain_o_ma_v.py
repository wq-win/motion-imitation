...
if __name__ == "__main__":
    ...
    motor_angle_v = torch.tensor(motor_angle_v, dtype=torch.float32).to(DEVICE)
    train_dataset = TensorDataset(motor_angle, motor_angle_v)
    ...
    plt.show()
    file_path = f"pretrain_model/o_ma_v_model_{NOWTIME}.pkl"
