...
TIMESTEP = data_augmentation.TIMESTEP
...
if __name__ == '__main__':
    ...
    with open('trot/dataset/trot_data_V_07_04_10_100.pkl', 'rb') as f:
    ...
    SUM_NUMS = len(input_array)
    color = np.zeros((SUM_NUMS, 3))
    ...
    if  SUM_NUMS > 1e3:
        ...
        index_range = (0, -1)
    trajactory_ploter(input_array, output_array, index_range=(0, 1000),dim=12, color_array=color, x=0, y=1, z=2, u=0, v=1, w=2)
    trajactory_ploter(input_array, output_array, index_range=(0, 1000),dim=12, color_array=color, x=3, y=4, z=5, u=3, v=4, w=5)
    trajactory_ploter(input_array, output_array, index_range=(0, 1000),dim=12, color_array=color, x=6, y=7, z=8, u=6, v=7, w=8)
    trajactory_ploter(input_array, output_array, index_range=(0, 1000),dim=12, color_array=color, x=9, y=10, z=11, u=9, v=10, w=11)
    # plt.figure()
    # for i in range(12):
    #     plt.subplot(4, 3, i+1)
