...
def main():
    ...
    while True:
        ...
        # next_oma = oma + displacement * TIMESTEP * DISPLACEMENT_RATE + test_model_offset.error_between_target_and_result(o) * 1
        next_oma = oma + displacement * TIMESTEP * DISPLACEMENT_RATE + test_model_offset.error_between_target_and_result(o) * 1
